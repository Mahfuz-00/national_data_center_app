...
import 'package:ndc_app/Analytics%20UI/analyticsUI.dart';
                      ...
                      GestureDetector(
                        ...
                        onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => AdminDashboard(shouldRefresh: true,)));
                        },
                        child: Container(
                          width: screenWidth / 3,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Divider(),
              SizedBox(height: 5),
            /*VisitorRequestInfoCardAdmin(name: 'Md. Abdur Sattar',
