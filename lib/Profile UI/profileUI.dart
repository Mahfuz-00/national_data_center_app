...
class _ProfileState extends State<Profile> {
  ...
  Widget _buildDataCouple(IconData icon, String label, String value) {
    ...
    if (value == "ndc_vendor") {
      displayedValue = "Vendor";
    } else if (value == "ndc_internal"){
      displayedValue = "BCC Staff";
    } else if (value == "ndc_customer"){
      displayedValue = "NDC Customer";
    }else if (value == "ndc_admin"){
      displayedValue = "Admin";
    }else if (value == "ndc_security_admin"){
      displayedValue = "Security Admin";
    }else{
