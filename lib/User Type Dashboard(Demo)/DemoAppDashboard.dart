...
class NDCDashboard extends StatefulWidget {
  const NDCDashboard({super.key});

  @override
  State<NDCDashboard> createState() => _NDCDashboardState();
}
            ...
            ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const VisitorDashboard()));
                },
                child: Text('Visitor',
                    style: TextStyle(
                      color: Colors.white,
